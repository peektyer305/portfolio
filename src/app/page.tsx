    ...
    <main className="">
      <div className="text-white bg-center bg-cover bg-magic relative min-h-screen z-[-20]">
        ...
        <div className="flex justify-center fadeIn flex-col text-center">
          <h1 className="mx-auto bg-clip-text text-[100px] font-bold mt-20 md:text-[50px] sm:text-[50px]">Hello World!</h1>
          <p className="mt-20 md:mt-10 font-semibold text-[30px] text-wrap bg-clip-text">I am Masaki Hirabayashi majoring in Computer Science,</p>
          <p className="mt-10 font-semibold text-[30px] text-wrap bg-clip-text">interested in Front-end and Back-end development!</p>
        </div>
        <div className="flex flex-col justify-center mx-20 pb-20 md:pb-10 md:mx-10">
          <h2 className="text-[80px] font-semibold mx-auto mt-20 md:mt-10 md:text-[50px]">About me</h2>
